 ...
 * @since 1.0-SNAPSHOT
 */
class Templar(override val player: Creeplayer, override val id: String, override var location: Location) :
        AbstractAgent() {
